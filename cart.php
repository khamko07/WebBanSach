                ...
                case "submit":
                    ...
                    elseif (isset($_POST['order_click'])){
                        ...
                        if($error == false && !empty($_POST['quantity'])){//Xử lis lưu giỏ hàng vào databasse
                            ...
                            $insertOrder = mysqli_query($data, "INSERT INTO `orders` (`id`, `username`, `name`, `phone`, `address`, `note`, `total`, `created_time`, `last_update`) 
                            VALUES (NULL,'" .$_SESSION['current_user']. "', '" . $_POST['name'] . "',  '" . $_POST['phone'] . "', '" . $_POST['address'] . "', '" . $_POST['note'] . "', '" . $total . "', '" .$current_time . "', '" . time() . "');");
                            $orderID = $data->insert_id;
                            $insertString = "";
                            foreach ($orderProducts as $key => $product) {
                                $insertString .= "(NULL, '" . $orderID . "', '" . $product['id'] . "', '" . $_POST['quantity'][$product['id']] . "', '" . $product['price'] . "', '" .$current_time . "', '" . time() . "')";
        ...
        <?php if (!empty($error)) { ?> 
           ...
           <?php } else { ?>
            ...
            <form id="cart-form" action="cart.php?action=submit" method="POST">
                <table>
                    <tr><th class="product-number">STT</th>
